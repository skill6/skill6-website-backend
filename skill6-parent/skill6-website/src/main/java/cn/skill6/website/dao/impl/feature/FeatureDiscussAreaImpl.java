...
import cn.skill6.website.dao.intf.feature.FeatureDiscussAreaOper;
 ...
 */
public class FeatureDiscussAreaImpl implements FeatureDiscussAreaOper {
  private static final Logger logger = LoggerFactory.getLogger(FeatureDiscussAreaImpl.class);
