...
import cn.skill6.website.dao.intf.feature.FeatureCategoryInfoOper;
 ...
 */
public class FeatureCategoryInfoImpl implements FeatureCategoryInfoOper {
  private static final Logger logger = LoggerFactory.getLogger(FeatureCategoryInfoImpl.class);
